...
class NPC(pygame.sprite.Sprite):
    def __init__(self, window: pygame.surface.Surface, index):
        ...
        self.order_image = pygame.transform.scale(
            pygame.image.load("Assets/Images/Icons/speechBubble.png"), (50, 50)
        )
        self.state = "move"
        self.speed = 5
        self.wobble_value = 0
    ...
    def get_image(self) -> pygame.surface.Surface:
        images = [
            pygame.transform.scale(
                pygame.image.load("Assets/Images/Sprites/NPC_1.png"), (50, 50)
            ),
            pygame.transform.scale(
                pygame.image.load("Assets/Images/Sprites/NPC_2.png"), (50, 50)
            ),
            pygame.transform.scale(
                pygame.image.load("Assets/Images/Sprites/NPC_3.png"), (50, 50)
            ),
        ]
...
def try_spawn_npc(
    window, npcs: list[NPC], min: int, max: int, chance_per_frame: int
) -> list[NPC]:
    used_indexes = []
